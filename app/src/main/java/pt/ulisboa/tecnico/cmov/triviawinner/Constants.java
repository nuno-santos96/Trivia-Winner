...
public class Constants {
    ...
    public static final String QUESTION_SIZES = "question_sizes";
    public static final String OPTIONS_SIZES = "options_sizes";
    
    public static final String HQ = "HQ";
    public static final String CASH_SHOW = "CashShow";
    public static final String HANGTIME = "Hangtime";
